    ...
    class User{
        ...
        public function loginUsers($username, $password){
            ...
            if($canUserLogin){
                ...
                $json['success'] = 1;
                $json['message'] = "Successfully logged in whattttt";
		...
		//for attendance 
		     public function logAttendance($lecture, $wk, $sNum){
				  $json = array();          
				$lecString = $lecture;
                $query = "insert into ".$this->db_table2." (lecture, wk, sNum, created_at) values ('$lecture', '$wk', '$sNum', NOW())";
                ...
                if($inserted == 1){
                    ...
                    $json['success'] = 1;
                    $json['message'] = "Successfully logged the user";
                    
                }else{
                    
                    $json['success'] = 0;
                    $json['message'] = "Error in loggings";
